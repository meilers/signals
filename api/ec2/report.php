...
$reportType = mysql_escape_string($reportType);
$comments = mysql_escape_string($comments);


$sql = "INSERT INTO users_reports (userId, userReportedId, reportType, comments) VALUES ($userId, $personId, $reportType, '$comments')";

...
$userId = $json['userId'];
$selfSummary = $json['selfSummary'];
$hometown = $json['hometown'];
$occupation = $json['occupation'];
$education = $json['education'];
$music = $json['favoriteMusic'];
$drinks = $json['favoriteDrinks'];
$interests = $json['interests'];


$userId = mysql_escape_string($userId);
$selfSummary = mysql_escape_string($selfSummary);
$hometown = mysql_escape_string($hometown);
...
$sql = "UPDATE users SET selfSummary = '$selfSummary', hometown = '$hometown', occupation = '$occupation',
		education = '$education', music = '$music', drinks = '$drinks', interests = '$interests'
		WHERE userId = $userId";

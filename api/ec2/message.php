...
if( mysql_num_rows($query) > 0 )
{
	...
	{
		$sql = "INSERT INTO users_messages (userId, userMessagedId, placeId, message, messageTime) VALUES ($userId, $personId, $placeId, '$msg', UTC_TIMESTAMP())";
		...
		if ($query)
		{
		    ...
		    if (mysql_num_rows($query) > 0)
		    {
		        ...
		        echo json_encode(array( 'ok' => '0', 'error' => '7' ));	
		}
		else

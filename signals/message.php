...
$msgType = mysql_escape_string($msgType);

$sql = "INSERT INTO users_messages (userId, userMessagedId, placeId, messageType, messageTime) VALUES ($userId, $personId, $placeId, $msgType, UTC_TIMESTAMP())";
...
if ($query)
{
    ...
    if (mysql_num_rows($query) > 0)
    {
        ...
        $data = array(
            ...
            'type' => 'android',
            'data' => array(
                'alert' => $row['username'] . ' sent you a message!',
                'title' => '@ ' . $row['name'],

...
public class MyLocation {
    ...
    public boolean getLocation(Context context, LocationResult result, int minTime, int minDistance, int waitingTime, boolean updateAsap )
    {
        ...
        timer1=new Timer();
        timer1.schedule(new GetLastLocation(), waitingTime);
        return true;
    }
